                ...
                series: [
                    {
                        ...
                        data: [          // 数据数组，name 为数据项名称，value 为数据项值
                            <c:forEach items="${canteenWork}" var="canteen">
                ...
                series: [
                    {
                        ...
                        radius: '55%',
                        data: [          // 数据数组，name 为数据项名称，value 为数据项值
                            <c:forEach items="${canteenNonWork}" var="canteen">
                            {value:${canteen.count}, name: '${canteen.name}'},
                            </c:forEach>
                        ],
                        itemStyle: {
